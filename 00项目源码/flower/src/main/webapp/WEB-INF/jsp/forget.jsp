		...
		<form action="forget" method="post">
			<table border="0" height="600px" width="500px" id="center-login">
				<tr height="60px">
					...
					<td align="center"><input type="text" placeholder="请输入用户名" name="name"
						style="width: 250px;"></td>
				</tr>
				<tr height="60px">
					<td width="150px" align="center">联系方式</td>
					<td align="center"><input type="text"
						placeholder="请输入联系方式" style="width: 250px;" name="phone"></td>
				</tr>
				<tr height="60px">
				...
				<tr height="60px">
					...
					<td align="center"><input type="text" placeholder="请再次输入密码" name="pwd2"
						style="width: 250px;"></td>
				</tr>
				<tr height="80px">
					<td></td>
				...
				<tr>
					<td colspan="2" id="center-login-1">
						<div class="center-login-down">
							<p>用户注册/登录说明 <a href="loginin">返回</a></p>
