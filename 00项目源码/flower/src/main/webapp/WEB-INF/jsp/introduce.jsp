		...
		<div class="all">
			<div class="m-top">
				...
				<ul id="m-top-1">
					...
					<li>
						<a href="userin"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></a>
					</li>
					<li>
			...
			<div class="s-top">
				...
				<ul>
					...
					<li>
						<a href="allshop">所有商品</a>
					</li>
					<li>
						<a href="forpay">支付方式</a>
					</li>
					<li>
						<a href="intro">关于花语</a>
					</li>
			...
			<div class="center1">
				<img src="img/introduce.jpg" style="width: 1600px; height: 500px;"  align="center"/>
			</div>
			<div class="center">
				<div class="left-1"><img src="img/p4.png" style="width: 850px; height: 100px;" />
				<span style="font-family:微软雅黑;">
					<span style="color:#808080;">
						<span style="font-size:18px;">
		   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;从店铺装修到花卉设计，这里到处都飘散着柔情而文艺的气息。以粉色、紫色系为主打，配上各种清秀的小花，精致地包装让你捧着它都会立刻成为街上的焦点，连许多演艺 界的明星都是它的常客。
							</span>
						</span>
					</span>
					<p></p>
